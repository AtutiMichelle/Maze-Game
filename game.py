...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y, direction):
        super().__init__()
        # Create a surface with alpha channel for smooth circle
        self.image = pygame.Surface([24, 24], pygame.SRCALPHA)
        # Draw a red circle with a slightly darker border
        pygame.draw.circle(self.image, (200, 0, 0), (12, 12), 10)  # Main circle
        pygame.draw.circle(self.image, RED, (12, 12), 10, 2)  # Border
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
